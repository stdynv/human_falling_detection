...
# Initialize SocketIO with eventlet async mode and the specific allowed origin
socketio = SocketIO(app, debug=True, cors_allowed_origins=["https://flask-ehpad-fde5f2fndkd0f2gk.eastus-01.azurewebsites.net"], async_mode='eventlet')

# CORS configuration to allow only the specific Azure URL
